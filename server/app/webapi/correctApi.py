...
class CorrectApi(Resource):
    ...
    def post(self):
        ...
        for word in problem_detail:
            ...
            correction.append({'origin_text' : origin_text,
        ...
        try: 
            ...
            retInfo = {
                ...
                'recommand_article': recommand_article,
            }
            # r.articles += data
            # db.session.add(r)
        ...
        return jsonify(code = 200, message = "成功", retInfo = retInfo)